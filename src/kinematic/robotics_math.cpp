 ...
 */
 ...
 int robotics_math::getJacobianGeneral(const double* q_in,const double* alpha, const double* a,const double* d, const int dim, double Jacob[6][num_joints_ ])
 {
	 double Z[num_joints_ ][3]{};
	 double P[num_joints_ ][3]{};
	 double Jv[num_joints_ ][3]{};
	 double Jw[num_joints_ ][3]{};
